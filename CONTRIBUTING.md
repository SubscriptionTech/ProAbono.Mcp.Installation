...
- Do not bump the version. The release identity lives in four places that `tests/release.test.ts`
  ...
  and it is bumped by the maintainer who pushes your change, not in the pull request itself. A bump
  in a pull request collides with that one and is asked to be removed. Releasing is a maintainer
